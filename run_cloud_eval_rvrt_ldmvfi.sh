...
SPLITS_TAG="${SPLITS//,/_}"
OUT_DIR="${OUT_DIR:-$ROOT_DIR/eval_results_rvrt_ldmvfi/${SPLITS_TAG}/${SR_MODE}}"
...
EVEN_CORRECTOR_MODE="${EVEN_CORRECTOR_MODE:-residual}"
EVEN_CORRECTOR_FUSION_INIT_PRED_LOGIT="${EVEN_CORRECTOR_FUSION_INIT_PRED_LOGIT:-8.0}"
EVEN_CORRECTOR_FUSION_GATE_INIT_BIAS="${EVEN_CORRECTOR_FUSION_GATE_INIT_BIAS:--4.0}"
...
echo "even_corrector_mode=$EVEN_CORRECTOR_MODE"
echo "even_corrector_fusion_init_pred_logit=$EVEN_CORRECTOR_FUSION_INIT_PRED_LOGIT"
echo "even_corrector_fusion_gate_init_bias=$EVEN_CORRECTOR_FUSION_GATE_INIT_BIAS"
...
for SPLIT_NAME in "${SPLIT_ARRAY[@]}"; do
  ...
  if [[ -n "$EVEN_CORRECTOR_CKPT" ]]; then
    CMD+=(
      ...
      --even_corrector_mode "$EVEN_CORRECTOR_MODE"
      --even_corrector_fusion_init_pred_logit "$EVEN_CORRECTOR_FUSION_INIT_PRED_LOGIT"
      --even_corrector_fusion_gate_init_bias "$EVEN_CORRECTOR_FUSION_GATE_INIT_BIAS"
