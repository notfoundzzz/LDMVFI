...
class _ConditionBridgeBootstrap(nn.Module):
...
class _LatentDiffusionVFIStsrBootstrap(nn.Module):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.condition_bridge = _ConditionBridgeBootstrap(hidden_channels=bridge_hidden_channels)
