        ...
        if pretrained:
            try:
                if hasattr(models, "VGG16_Weights"):
                    ...
                    vgg_pretrained_features = models.vgg16(pretrained=True, progress=False).features
                ...
                if hasattr(models, "VGG16_Weights"):
                    ...
                    vgg_pretrained_features = models.vgg16(pretrained=False, progress=False).features
        else:
            if hasattr(models, "VGG16_Weights"):
                vgg_pretrained_features = models.vgg16(weights=None, progress=False).features
            else:
